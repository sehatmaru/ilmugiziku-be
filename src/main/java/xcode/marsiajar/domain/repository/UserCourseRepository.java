...
import xcode.marsiajar.domain.model.UserCourseRelModel;
...
public interface UserCourseRepository extends JpaRepository<UserCourseRelModel, String> {
   ...
   UserCourseRelModel getActiveUserCourseBySecureId(String secureId);
   ...
   UserCourseRelModel getUserCourseBySecureId(String course);
}
